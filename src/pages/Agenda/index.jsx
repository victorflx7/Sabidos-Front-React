                                ...
                                >
                                    <div className="flex justify-between items-start">
                                        ...
                                        {event.descriptionEvent && (
                                            <p className="text-gray-300 text-sm m-0 mb-2 bg-blue-500/20 p-2 rounded">
                                                📝 <strong>Descrição:</strong> {event.descriptionEvent}
                                            </p>
                                        )}
                                        {event.localEvento && (
                                            <p className="text-gray-400 text-xs m-0 flex items-center gap-1 bg-green-500/20 p-2 rounded">
